...
const posts = [
  ...
  ,{
    ...
    dateIso: "2026-04-29",
    tag: "nota",
    body: "Creo que la clave esta en como siempre dicen todos, ser mas egoista y pensar mas en mi mismo, yo siempre estoy dipuesto a autosacrificarme al instante por todos, pero eso no solo no sirve de nada, nadie lo valora y ahora hay que agregar que aleja a las personas, las asusta por que aparentemente es mucho compromiso que no pueden cumplir, y no importa si no lo pueden cumplir solo deben aceptarlo y no despreciarlo eso es todo, pero nooo tienen que ser unos ingratos, solo escribo esto para sentirme mejor, es una manera super efectiva de calmar los pensamientos al menos por un timepo, plasmarlos siempre me hace sentir mejor, es como cuando habla con jime, tiene el mismo efecto de sentirme comprendido, en fin ayuda\n\nEl plan es simple, empezar a concentrarme mas en mi y ser mas reservado, por que no puedo ser yo mismo, siempre he creido que el amor es amar a las personas tal y como son pero incluso esa percepcion es incorrecta por que es mia no la de nadie mas, y como el mundo es tan relativo andie puede estar de acuerdo en nada, en fin no vale la pena ser como quiero ser con nadie por que nadie es como yo, todos son personas centradas en si mismas, y no esta mal, es ese tipo de egoismo normal, por el contrario el que esta mal soy yo que parece que solo existo atravez de los ojos de los demas, en fin ser mas distante y poco a poco cambiar mi personalidad para ser mas apagado y protegerme a mi mismo\n\nVeremos como funciona\n\nNo es que el amor no exista, es que el amor que profeso no existe \n\nChao",
    signatureId: null
  }
];
